package cn.caam.gs.manage.dbmaintenance.view;
...
import cn.caam.gs.manage.dbmaintenance.table.DbGroupTableType;
...
public class DbMaintenanceViewHelper extends HtmlViewBaseHelper {
	...
	public static final String HTML_INDEX 				= "/indexDb";
	public static final String HTML_DBMAINTENANCE 		= "/dbMaintenance";
