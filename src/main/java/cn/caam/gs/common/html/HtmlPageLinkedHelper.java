...
public class HtmlPageLinkedHelper extends HtmlBaseHelper {
    ...
    public static String getPageLinkedHtml(PaginationHolder paginationHolder) {
        ...
        if(Objects.nonNull(paginationHolder) && paginationHolder.getPageCount() > 1) {
            ...
            sb.append("<div class='col-10 text-left'>");
            ...
            if(!paginationHolder.isFirstPage()) {
                ...
                sb.append(" type='button' class='btn btn_pageLink card-radius-leftRad btn-outline-secondary'>");
            ...
            for(int i=paginationHolder.getFirstLinkedPage(); i<=paginationHolder.getLastLinkedPage(); i++) {
                ...
                sb.append(" class='btn btn_pageLink btn-outline-secondary");
            ...
            if(!paginationHolder.isLastPage()) {
                ...
                sb.append("type='button' class='btn btn_pageLink card-radius-rightRad btn-outline-secondary'>");
            ...
            sb.append("<span class='text-muted' style='font-size: 14px;padding: 0px 0px 0px 0px;'><strong>(");
