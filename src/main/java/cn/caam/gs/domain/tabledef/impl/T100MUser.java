...
public class T100MUser extends BaseTableDef implements BaseDdl{
    ...
    public static final ColumnInfoForm[] cols = new ColumnInfoForm[] {
        ...
        new ColumnInfoForm(COL_USER_TYPE,        false,    MySqlType.CHARACTER_VARYING.getType(), 6  , null, null, false, "", getLabelName(TABLE_NAME, COL_USER_TYPE),        getPlaceholder(TABLE_NAME, COL_USER_TYPE)),
        ...
        new ColumnInfoForm(COL_MEMBERSHIP_PATH,  false,    MySqlType.CHARACTER_VARYING.getType(), 6  , null, null, false, "", getLabelName(TABLE_NAME, COL_MEMBERSHIP_PATH),  getPlaceholder(TABLE_NAME, COL_MEMBERSHIP_PATH)),
        ...
        new ColumnInfoForm(COL_SEX,              false,    MySqlType.CHARACTER_VARYING.getType(), 6  , null, null, false, "", getLabelName(TABLE_NAME, COL_SEX),              getPlaceholder(TABLE_NAME, COL_SEX)),
        ...
        new ColumnInfoForm(COL_NATIONALITY,      false,    MySqlType.CHARACTER_VARYING.getType(), 6  , null, null, false, "", getLabelName(TABLE_NAME, COL_NATIONALITY),      getPlaceholder(TABLE_NAME, COL_NATIONALITY)),
        new ColumnInfoForm(COL_POLITICAL,        false,    MySqlType.CHARACTER_VARYING.getType(), 6  , null, null, false, "", getLabelName(TABLE_NAME, COL_POLITICAL),        getPlaceholder(TABLE_NAME, COL_POLITICAL)),
        new ColumnInfoForm(COL_EDU_DEGREE,       false,    MySqlType.CHARACTER_VARYING.getType(), 6  , null, null, false, "", getLabelName(TABLE_NAME, COL_EDU_DEGREE),       getPlaceholder(TABLE_NAME, COL_EDU_DEGREE)),
        new ColumnInfoForm(COL_BACHELOR,         false,    MySqlType.CHARACTER_VARYING.getType(), 6  , null, null, false, "", getLabelName(TABLE_NAME, COL_BACHELOR),         getPlaceholder(TABLE_NAME, COL_BACHELOR)),
        new ColumnInfoForm(COL_POSITION,         false,    MySqlType.CHARACTER_VARYING.getType(), 6  , null, null, true , "", getLabelName(TABLE_NAME, COL_POSITION),         getPlaceholder(TABLE_NAME, COL_POSITION)),
        ...
        new ColumnInfoForm(COL_EMPLOYER_TYPE,    false,    MySqlType.CHARACTER_VARYING.getType(), 6  , null, null, false, "", getLabelName(TABLE_NAME, COL_EMPLOYER_TYPE),    getPlaceholder(TABLE_NAME, COL_EMPLOYER_TYPE)),
        new ColumnInfoForm(COL_JOB_TITLE,        false,    MySqlType.CHARACTER_VARYING.getType(), 6  , null, null, false, "", getLabelName(TABLE_NAME, COL_JOB_TITLE),        getPlaceholder(TABLE_NAME, COL_JOB_TITLE)),
        new ColumnInfoForm(COL_CERTIFICATE_TYPE, false,    MySqlType.CHARACTER_VARYING.getType(), 6  , null, null, false, "", getLabelName(TABLE_NAME, COL_CERTIFICATE_TYPE), getPlaceholder(TABLE_NAME, COL_CERTIFICATE_TYPE)),
        ...
        new ColumnInfoForm(COL_AREA,             false,    MySqlType.CHARACTER_VARYING.getType(), 6  , null, null, false, "", getLabelName(TABLE_NAME, COL_AREA),             getPlaceholder(TABLE_NAME, COL_AREA)),
        ...
        new ColumnInfoForm(COL_VALID_STATUS,     false,    MySqlType.CHARACTER_VARYING.getType(), 6 , null, null, false, "",  getLabelName(TABLE_NAME, COL_VALID_STATUS),     getPlaceholder(TABLE_NAME, COL_VALID_STATUS)),
